...
public class DatabaseSeeder {
    ...
    private static Map<String, AttributeValue> createTableItem(String maBan, String viTri, int sucChua, String loaiBan,
            String trangThai) {
        Map<String, AttributeValue> item = new HashMap<>();
    ...
    private static void seedMenu() {
        ...
        Object[][] menu = {
                // CAT001: Khai vị & Gỏi
                { "CAT001", "MN001", "Gỏi Ngó Sen Tôm Thịt", 85000.0,
                        "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=500" },
                { "CAT001", "MN002", "Đậu Hũ Chiên Chao", 45000.0,
                        "https://images.unsplash.com/photo-1512058560566-42724afbc1db?w=500" },
                { "CAT001", "MN003", "Khô Mực Nướng Tương Ớt", 120000.0,
                        "https://images.unsplash.com/photo-1563379926898-05f4575a45d8?w=500" },

                // CAT002: Đặc sản Đồng Quê
                { "CAT002", "MN004", "Cá Lóc Nướng Trui", 155000.0,
                        "https://images.unsplash.com/photo-1580476262798-bddd9f4b7369?w=500" },
                { "CAT002", "MN005", "Chuột Đồng Chiên Nước Mắm", 95000.0,
                        "https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=500" },
                { "CAT002", "MN006", "Ếch Núp Lùm (Chiên Rơm)", 110000.0,
                        "https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=500" },

                // CAT003: Món Nhậu Lai Rai
                { "CAT003", "MN007", "Ốc Bươu Hấp Tiêu Xanh", 75000.0,
                        "https://images.unsplash.com/photo-1599481238640-4c1288750d7a?w=500" },
                { "CAT003", "MN008", "Cánh Gà Chiên Nước Mắm", 85000.0,
                        "https://images.unsplash.com/photo-1567620905732-2d1ec7bb7445?w=500" },
                { "CAT003", "MN009", "Sụn Gà Rang Muối", 90000.0,
                        "https://images.unsplash.com/photo-1606787366850-de6330128bfc?w=500" },

                // CAT004: Lẩu & Món Chính
                { "CAT004", "MN010", "Lẩu Mắm Miền Tây (Nhỏ)", 250000.0,
                        "https://images.unsplash.com/photo-1547592166-23ac45744acd?w=500" },
                { "CAT004", "MN011", "Vịt Nấu Chao", 185000.0,
                        "https://images.unsplash.com/photo-1514326640560-7d063ef2aed5?w=500" },
                { "CAT004", "MN012", "Lẩu Cháo Cá Lóc", 220000.0,
                        "https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?w=500" },

                // CAT005: Đồ uống
                { "CAT005", "MN013", "Rượu Nếp Gò Đen (Xị)", 45000.0,
                        "https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=500" },
                { "CAT005", "MN014", "Bia Tiger (Thùng)", 420000.0,
                        "https://images.unsplash.com/photo-1566633806327-68e152aaf26d?w=500" },
                { "CAT005", "MN015", "Nước Suối Lavie", 15000.0,
                        "https://images.unsplash.com/photo-1559839734-2b71f1e3c7e0?w=500" }
        };
    ...
    private static void seedPromos() {
        ...
        Object[][] promos = {
                { "KM001", "Giảm giá Khai trương", "Giảm 10% tổng hóa đơn", 10.0, now.minusDays(5).toString(),
                        now.plusDays(30).toString() },
                { "KM002", "Mừng Lễ 30/4", "Giảm 20% cho nhóm trên 5 người", 20.0, now.minusDays(10).toString(),
                        now.minusDays(1).toString() },
                { "KM003", "Sắp diễn ra - Quốc tế Thiếu nhi", "Tặng quà cho trẻ em", 5.0, now.plusDays(10).toString(),
